        ...
        <section className="px-6 pt-16 pb-12 sm:pt-24 sm:pb-16">
          <div className="mx-auto max-w-3xl">
            <div className="flex flex-col items-center text-center">
              {/* Logo badge */}
              <div className="mb-8 flex h-28 w-28 items-center justify-center rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-sm shadow-2xl shadow-amber-500/10">
                <img
                  src="/aibd_logo.svg"
                  alt="aibd.ai"
